{title}Completed Tasks (Weekly){/title}
{add_bread_crumb}Completed Tasks (Weekly){/add_bread_crumb}
...
<div id="weekly_completed_tasks_report" class="filter_criteria">
  <form action="{assemble route=weekly_completed_tasks_reports_run}" method="get" class="expanded">
...
<script type="text/javascript">
  $('#weekly_completed_tasks_report').filterCriteria({
    'on_result_links' : function(response, data, links) {
      App.Wireframe.Utils.reportRegisterExportLinks('{assemble route=weekly_completed_tasks_reports_export}', response, data, links);
    },
    'criterions' : {
    ...
    'new_filter_url' : '{assemble route=weekly_completed_tasks_reports_add}',
    'can_add_filter' : true,
