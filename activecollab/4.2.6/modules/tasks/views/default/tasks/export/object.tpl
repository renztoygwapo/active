<div id="object_main_info" class="object_info">
  <h1>{lang}Task{/lang}: {$object->getName()}</h1>
</div>
...
<div id="object_timerecords" class="object_info">
  <h3>{lang}Time Records{/lang}</h3>
  {project_exporter_object_timerecords timerecords=$timerecords total=$total_time user=$logged_user}
</div>
{/if}
