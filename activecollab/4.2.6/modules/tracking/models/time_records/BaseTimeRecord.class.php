<?php
  ...
  /**
   * BaseTimeRecord class
   *
   * @package ActiveCollab.modules.tracking
   * @subpackage models
   */
  abstract class BaseTimeRecord extends TrackingObject {
     ...
     * @var string
     */
    protected $table_name = 'time_records';
     ...
     * @var array
     */
    protected $fields = array('id', 'parent_type', 'parent_id', 'job_type_id', 'state', 'original_state', 'record_date', 'value', 'user_id', 'user_name', 'user_email', 'summary', 'billable_status', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email');
