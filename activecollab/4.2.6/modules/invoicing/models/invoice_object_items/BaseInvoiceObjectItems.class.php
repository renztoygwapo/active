<?php
  ...
  /**
   * BaseInvoiceObjectItems class
   *
   * @package ActiveCollab.modules.invoicing
   * @subpackage models
   */
  abstract class BaseInvoiceObjectItems extends DataManager {
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'invoice_object_items' : 'invoice_object_items';
    } // getTableName
