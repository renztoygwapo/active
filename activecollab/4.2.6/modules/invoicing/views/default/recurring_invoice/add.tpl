{title}New Recurring Profile{/title}
{add_bread_crumb}New Recurring Profile{/add_bread_crumb}
{use_widget name="invoice_form" module="invoicing"}

<div id="add_recurring_profile">
  {form action={$active_recurring_profile->getAddUrl()} method=post id=add_recurring_profile_form class="big_form"}
    ...
    {wrap_buttons}
      {submit}Add Recurring Profile{/submit}
    {/wrap_buttons}
  {/form}
</div>
<script type="text/javascript">
$('#add_recurring_profile').invoiceForm({
