<?php
  ...
  /**
   * BaseSourceRepositories class
   *
   * @package ActiveCollab.modules.source
   * @subpackage models
   */
  abstract class BaseSourceRepositories extends DataManager {
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'source_repositories' : 'source_repositories';
    } // getTableName
