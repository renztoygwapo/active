<div id="discussion_working_box" class="working_box">
  ...
  {wrap field=notify_sender}
    {label for=notify_sender}Send notification email and create public page{/label}
  	{checkbox name="filter[action_parameters][notify_sender]" id="notify_sender" label="Subscribe and notify sender and all cc recipients" object_name='discussion' value=1 checked=$filter_data.action_parameters.notify_sender}
