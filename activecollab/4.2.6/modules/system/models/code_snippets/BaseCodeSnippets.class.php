<?php
  ...
  /**
   * BaseCodeSnippets class
   *
   * @package ActiveCollab.modules.system
   * @subpackage models
   */
  abstract class BaseCodeSnippets extends DataManager {
    ...
    static function getModelName($underscore = false) {
      return $underscore ? 'code_snippets' : 'CodeSnippets';
    } // getModelName
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'code_snippets' : 'code_snippets';
    } // getTableName
