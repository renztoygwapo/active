<?php
  ...
  /**
   * BaseCodeSnippet class
   *
   * @package ActiveCollab.modules.system
   * @subpackage models
   */
  abstract class BaseCodeSnippet extends ApplicationObject {
     ...
     * @var string
     */
    protected $table_name = 'code_snippets';
     ...
     * @var array
     */
    protected $fields = array('id', 'parent_type', 'parent_id', 'syntax', 'body', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email');
    ...
    function getModelName($underscore = false, $singular = false) {
      if($singular) {
        return $underscore ? 'code_snippet' : 'CodeSnippet';
      } else {
    ...
    /**
     * Return value of syntax field
     *
     * @return string
     */
    function getSyntax() {
      return $this->getFieldValue('syntax');
    } // getSyntax
    
    /**
     * Set value of syntax field
     *
     * @param string $value
     * @return string
     */
    function setSyntax($value) {
      return $this->setFieldValue('syntax', $value);
    } // setSyntax
