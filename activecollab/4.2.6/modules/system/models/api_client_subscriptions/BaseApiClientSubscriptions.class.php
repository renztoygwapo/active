<?php
  ...
  /**
   * BaseApiClientSubscriptions class
   *
   * @package ActiveCollab.modules.system
   * @subpackage models
   */
  abstract class BaseApiClientSubscriptions extends DataManager {
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'api_client_subscriptions' : 'api_client_subscriptions';
    } // getTableName
