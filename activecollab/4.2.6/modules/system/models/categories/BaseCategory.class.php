<?php
   ...
   * @subpackage models
   */
  abstract class BaseCategory extends ApplicationObject {
     ...
     * @var array
     */
    protected $fields = array('id', 'type', 'parent_type', 'parent_id', 'name', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email');
