<?php
   ...
   * @subpackage models
   */
  abstract class BaseAttachment extends ApplicationObject {
     ...
     * @var array
     */
    protected $fields = array('id', 'type', 'parent_type', 'parent_id', 'state', 'original_state', 'name', 'mime_type', 'size', 'location', 'md5', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'raw_additional_properties');
