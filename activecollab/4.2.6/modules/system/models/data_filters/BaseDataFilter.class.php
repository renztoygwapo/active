<?php
   ...
   * @subpackage models
   */
  abstract class BaseDataFilter extends ApplicationObject {
     ...
     * @var array
     */
    protected $fields = array('id', 'type', 'name', 'raw_additional_properties', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'is_private');
