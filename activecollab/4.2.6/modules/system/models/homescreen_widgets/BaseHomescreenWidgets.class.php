<?php
  ...
  /**
   * BaseHomescreenWidgets class
   *
   * @package ActiveCollab.modules.system
   * @subpackage models
   */
  abstract class BaseHomescreenWidgets extends DataManager {
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'homescreen_widgets' : 'homescreen_widgets';
    } // getTableName
