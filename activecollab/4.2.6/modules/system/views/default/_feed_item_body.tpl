...
<p>
  ...
  {$_object->getVerboseType()} <a href="{$_object->getViewUrl()}">{$_object->getName()}</a> {lang}{$_activity->getAction()}{/lang}
</p>
<p><span style="font-weight: bold">{lang}By{/lang}:</span> {user_link user=$_activity->getCreatedBy()}</p>
{if $_activity->getComment()}
<p><span style="font-weight: bold">{lang}Comment{/lang}:</span> {$_activity->getComment()}</p>
{/if}