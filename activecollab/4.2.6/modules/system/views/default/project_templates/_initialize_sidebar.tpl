<script type="text/javascript">
	...
	(function() {
		var positions             = {$positions|json nofilter};
		var task_categories       = {$task_categories|json nofilter};
		var discussion_categories = {$discussion_categories|json nofilter};
		var file_categories       = {$file_categories|json nofilter};
		var files                 = {$files|json nofilter};
