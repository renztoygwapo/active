<?php
  ...
  /**
   * BaseTextDocumentVersions class
   *
   * @package ActiveCollab.modules.files
   * @subpackage models
   */
  abstract class BaseTextDocumentVersions extends DataManager {
    ...
    static function getModelName($underscore = false) {
      return $underscore ? 'text_document_versions' : 'TextDocumentVersions';
    } // getModelName
    ...
    static function getTableName($with_prefix = true) {
      return $with_prefix ? TABLE_PREFIX . 'text_document_versions' : 'text_document_versions';
    } // getTableName
