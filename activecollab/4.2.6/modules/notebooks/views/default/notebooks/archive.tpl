...
<div id="notebooks"><div id="notebooks_inner">
  ...
  <div class="section_button_wrapper notebooks_archive_button_wrapper">
    <a href="{assemble route=project_notebooks project_slug=$active_project->getSlug()}" class="section_button"><span><img src="{image_url name='icons/16x16/go-to-project.png' module='environment'}">{lang}Active Notebooks{/lang}</span></a>
  </div>
