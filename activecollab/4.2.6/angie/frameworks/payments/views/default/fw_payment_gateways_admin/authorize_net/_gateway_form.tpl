...
{wrap field="paymentGatewayAPIUserName" class="payment_user_form"}
  {label for=paymentGatewayAPIUserName required=yes}API Login Id{/label}
  {text_field name='payment_gateway[additional_properties][api_login_id]' id='paymentGatewayAPIUserName' value=$payment_gateway_data.api_login_id required=true}
{/wrap}

{wrap field="paymentGatewayAPIPassword" class="payment_user_form"}
  {label for=paymentGatewayAPIPassword required=yes}Transaction Id{/label}
  {text_field name='payment_gateway[additional_properties][transaction_id]' value=$payment_gateway_data.transaction_id id=paymentGatewayAPIPassword required=true}
{/wrap}
