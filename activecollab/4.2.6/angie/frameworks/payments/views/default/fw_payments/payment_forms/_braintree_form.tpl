...
{/wrap}
 ...
 {wrap field=name}
  ...
  {text_field name='payment[first_name]' value=$payment_data.first_name id=first_name}
 {/wrap}

 {wrap field=type}
  {label for=last_name}Last Name{/label}
  {text_field name='payment[last_name]' value=$payment_data.last_name id=last_name}
 {/wrap}
