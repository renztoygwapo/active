<?php
  ...
  /**
   * Subtask reopened notification
   *
   * @package angie.frameworks.subtasks
   * @subpackage notifications
   */
  abstract class FwSubtaskReopenedNotification extends BaseSubtaskNotification {
    ...
    function getMessage(IUser $user) {
      return lang("':name' subtask reopened", array(
    ...
    function getMessageForWebInterface(IUser $user) {
      ...
      if($sender instanceof IUser && $subtask instanceof Subtask) {
        return lang('<a href=":author_url" class=":author_link_classes">:author_name</a> has reopened <a href=":subtask_url" class="quick_view_item">":subtask_name"</a> subtask', array(
