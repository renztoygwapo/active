{$context->reminders()->getNotificationSubjectPrefix()}{lang name=$context->getName() language=$language}Reminder{/lang}
================================================================================
{notification_wrapper title='Reminder' context=$context context_view_url=$context_view_url recipient=$recipient sender=$sender}
